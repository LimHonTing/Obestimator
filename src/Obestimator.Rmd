...
> The app starts with a default interface. To try this app, user will need to input their details and answer the question provided. After user answering all the questions,the app will output the result.
